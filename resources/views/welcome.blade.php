		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="./sign-in.html" class="dropdown-item"> <form id="logout-form" action="{{ route('logout') }}" method="POST"
                            ...
                            <table class="table" id="dataKategori">
                              <thead>
                                <tr>
                                  ...
                                  <th><button class="table-sort" data-sort="sort-type">JK</button></th>
                                  <th><button class="table-sort" data-sort="sort-score">Nomor HP</button></th>
                                  <th><button class="table-sort" data-sort="sort-date">Email</button></th>
                                  <th><button class="table-sort" data-sort="sort-quantity">Jabatan</button></th>
                                  <th><button class="table-sort" data-sort="sort-progress">Status</button></th>
                                  <th><button class="table-sort" data-sort="sort-progress">Aksi</button></th>
                                </tr>
                              </thead>
                              <tbody class="table-tbody">

                                @foreach ($pegawaiModel as $item)<tr>
                                    ...
                                    <td>{{$item->jabatan}}</td>
                                    <td>
                                        <span class="badge bg-azure text-azure-fg">{{$item->status}}</span>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nama_lengkap" placeholder="Masukkan nama anda">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nomor_hp" placeholder="Masukkan nomor HP anda">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="jabatan" placeholder="Masukkan jabatan anda">
              </div>
              <div class="mb-3">
      ...
      // @formatter:on
        ...
        {{-- <script>
            $(document).ready(function() {
                ...
                const table = $('#dataKategori').DataTable({
                    processing: true,
                    serverSide: true,
                    scrollX: true,
                    autoWidth: false,
                    ajax: {
                        url: 'getDataPegawai', // Sesuaikan URL sesuai route yang dibuat
                        type: 'GET',
                        dataSrc: 'data' // Properti data pada JSON response
                    },
                    columns: [{
                            data: 'id',
                            orderable: false,
                            ...
                            render: function(data) {
                                return `<input type="checkbox" class="row-select select-item" value="${data}">`;
                            }
                        },
                        {
                            data: 'DT_RowIndex',
                    ...
                    dom: "<'row mb-3'<'col-sm-6'l><'col-sm-6 text-end'f>>" + // Search ke kanan dengan jarak
